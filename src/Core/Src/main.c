/**
  ...
  */
/*!
 \mainpage SCUTTLE Home Page

 \section intro_sec Introduction

 Welcome to the documentation of SCUTTLE. Please enjoy your stay
 
\subsection Drivers
 - [motor.h](\ref motor.h)
 - [motor.c](\ref motor.c)
 - [encoder.h](\ref encoder.h)
 - [encoder.c](\ref encoder.c)
 - [motorcontrol.h](\ref motorcontrol.h)
 - [motorcontrol.c](\ref motorcontrol.c)
