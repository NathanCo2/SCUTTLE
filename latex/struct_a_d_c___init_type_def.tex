...
\item 
\mbox{\hyperlink{group___exported__types_gac9a7e9a35d2513ec15c3b537aaa4fba1}{Functional\+State}} \mbox{\hyperlink{struct_a_d_c___init_type_def_a9f2cda697b30bc6c4d4fcd1eccd8c3cd}{Oversampling\+Mode}}
\item 
...
The setting of these parameters by function \doxylink{group___a_d_c___exported___functions___group1_ga33ddb73d4880bd425aaa43c5c52bb13a}{HAL\+\_\+\+ADC\+\_\+\+Init()} is conditioned to ADC state. ADC state can be either\+:
\begin{DoxyItemize}
...
\mbox{\hyperlink{group___exported__types_gac9a7e9a35d2513ec15c3b537aaa4fba1}{Functional\+State}} Low\+Power\+Auto\+Wait}

Select the dynamic low power Auto Delay\+: new conversion start only when the previous conversion (for ADC group regular) or previous sequence (for ADC group injected) has been retrieved by user software, using function \doxylink{group___a_d_c___exported___functions___group2_ga28d14ed45ffdd9bbb7b234bf5f21a739}{HAL\+\_\+\+ADC\+\_\+\+Get\+Value()} or \doxylink{group___a_d_c_ex___exported___functions___group1_gafd2cd8d547255edb84a050f1833c603a}{HAL\+\_\+\+ADCEx\+\_\+\+Injected\+Get\+Value()}. This feature automatically adapts the frequency of ADC conversions triggers to the speed of the system that reads the data. Moreover, this avoids risk of overrun for low frequency applications. This parameter can be set to ENABLE or DISABLE. Note\+: It is not recommended to use with interruption or DMA (\doxylink{group___a_d_c___exported___functions___group2_gaeb53035f47a937d54de2164d6c939a04}{HAL\+\_\+\+ADC\+\_\+\+Start\+\_\+\+IT()}, \doxylink{group___a_d_c___exported___functions___group2_ga7c3ef5532dddebe7fd76bb8f589d11fd}{HAL\+\_\+\+ADC\+\_\+\+Start\+\_\+\+DMA()}) since these modes have to clear immediately the EOC flag (by CPU to free the IRQ pending event or by DMA). Auto wait will work but fort a very short time, discarding its intended benefit (except specific case of high load of CPU or DMA transfers which can justify usage of auto wait). Do use with polling\+: 1. Start conversion with \doxylink{group___a_d_c___exported___functions___group2_ga193666e3bde978627c9ee1e2073c69c0}{HAL\+\_\+\+ADC\+\_\+\+Start()}, 2. Later on, when ADC conversion data is needed\+: use \doxylink{group___a_d_c___exported___functions___group2_gad9c0b5763ab75357407e22d310befc30}{HAL\+\_\+\+ADC\+\_\+\+Poll\+For\+Conversion()} to ensure that conversion is completed and \doxylink{group___a_d_c___exported___functions___group2_ga28d14ed45ffdd9bbb7b234bf5f21a739}{HAL\+\_\+\+ADC\+\_\+\+Get\+Value()} to retrieve conversion result and trig another conversion start. (in case of usage of ADC group injected, use the equivalent functions HAL\+\_\+\+ADCEx\+Injected\+\_\+\+Start(), \doxylink{group___a_d_c_ex___exported___functions___group1_gafd2cd8d547255edb84a050f1833c603a}{HAL\+\_\+\+ADCEx\+\_\+\+Injected\+Get\+Value()}, ...). \Hypertarget{struct_a_d_c___init_type_def_acc137bdcf502c586925ad8e99628b03f}\index{ADC\_InitTypeDef@{ADC\_InitTypeDef}!NbrOfConversion@{NbrOfConversion}}
...
\begin{DoxyItemize}
\item sequencer configured to fully configurable\+: Number of ranks in the scan sequence is configurable using this parameter. Note\+: After the first call of \textquotesingle{}\doxylink{group___a_d_c___exported___functions___group1_ga33ddb73d4880bd425aaa43c5c52bb13a}{HAL\+\_\+\+ADC\+\_\+\+Init()}\textquotesingle{}, each rank corresponding to parameter "{}\+Nbr\+Of\+Conversion"{} must be set using \textquotesingle{}\doxylink{group___a_d_c___exported___functions___group3_ga96f4317420984bec9226f7d93cb36f1b}{HAL\+\_\+\+ADC\+\_\+\+Config\+Channel()}\textquotesingle{}. Afterwards, when all needed sequencer ranks are set, parameter \textquotesingle{}Nbr\+Of\+Conversion\textquotesingle{} can be updated without modifying configuration of sequencer ranks (sequencer ranks above \textquotesingle{}Nbr\+Of\+Conversion\textquotesingle{} are discarded).
...
\mbox{\hyperlink{struct_a_d_c___oversampling_type_def}{ADC\+\_\+\+Oversampling\+Type\+Def}} Oversampling}
...
\mbox{\hyperlink{group___exported__types_gac9a7e9a35d2513ec15c3b537aaa4fba1}{Functional\+State}} Oversampling\+Mode}
